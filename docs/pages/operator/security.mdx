...
You can adjust isolation settings through helm values. The default values are (also check [values.yaml](https://github.com/spectrocloud/vcluster/blob/v0.7.0-alpha.1/charts/k3s/values.yaml)):
```yaml
isolation:
  enabled: false
